...
class ProcessBuilder(ProcessBuilderBase):
    ...
    def apply(self, process, context=UNSET) -> ProcessBuilder:
        ...
        """
        return apply(
            data=self, process=build_child_callback(process, parent_parameters=["x", "context"]), context=context
        )
    ...
    def ard_normalized_radar_backscatter(
        self,
        elevation_model=UNSET,
        contributing_area=UNSET,
        ellipsoid_incidence_angle=UNSET,
        noise_removal=UNSET,
        options=UNSET,
    ) -> ProcessBuilder:
        """
    ...
    def ard_surface_reflectance(
        ...
        elevation_model=UNSET,
        atmospheric_correction_options=UNSET,
        cloud_detection_options=UNSET,
    ) -> ProcessBuilder:
        """
    ...
    def flatten_dimensions(self, dimensions, target_dimension, label_separator=UNSET) -> ProcessBuilder:
        ...
        return flatten_dimensions(
            data=self, dimensions=dimensions, target_dimension=target_dimension, label_separator=label_separator
        )
    ...
    def linear_scale_range(self, inputMin, inputMax, outputMin=UNSET, outputMax=UNSET) -> ProcessBuilder:
        ...
        return linear_scale_range(
            x=self, inputMin=inputMin, inputMax=inputMax, outputMin=outputMin, outputMax=outputMax
        )
    ...
    def load_collection(self, spatial_extent, temporal_extent, bands=UNSET, properties=UNSET) -> ProcessBuilder:
        ...
        return load_collection(
            id=self, spatial_extent=spatial_extent, temporal_extent=temporal_extent, bands=bands, properties=properties
        )
    ...
    def load_stac(self, spatial_extent=UNSET, temporal_extent=UNSET, bands=UNSET, properties=UNSET) -> ProcessBuilder:
        ...
        """
        return load_stac(
            url=self, spatial_extent=spatial_extent, temporal_extent=temporal_extent, bands=bands, properties=properties
        )
    ...
    def reduce_spatial(self, reducer, context=UNSET) -> ProcessBuilder:
        ...
        """
        return reduce_spatial(
            data=self, reducer=build_child_callback(reducer, parent_parameters=["data", "context"]), context=context
        )
    ...
    def unflatten_dimension(self, dimension, target_dimensions, label_separator=UNSET) -> ProcessBuilder:
        ...
        :return: A data cube with the new shape. The dimension properties (name, type, labels, reference system
            and resolution) for all other dimensions remain unchanged.
        """
        return unflatten_dimension(
            data=self, dimension=dimension, target_dimensions=target_dimensions, label_separator=label_separator
        )
    ...
    def vector_to_random_points(
        self, geometry_count=UNSET, total_count=UNSET, group=UNSET, seed=UNSET
    ) -> ProcessBuilder:
        """
        ...
        """
        return vector_to_random_points(
            data=self, geometry_count=geometry_count, total_count=total_count, group=group, seed=seed
        )
...
def apply(data, process, context=UNSET) -> ProcessBuilder:
    ...
    """
    return _process(
        "apply", data=data, process=build_child_callback(process, parent_parameters=["x", "context"]), context=context
    )
...
def apply_kernel(data, kernel, factor=UNSET, border=UNSET, replace_invalid=UNSET) -> ProcessBuilder:
    ...
    """
    return _process(
        "apply_kernel", data=data, kernel=kernel, factor=factor, border=border, replace_invalid=replace_invalid
    )
...
def atmospheric_correction(data, method, elevation_model=UNSET, options=UNSET) -> ProcessBuilder:
    ...
    """
    return _process(
        "atmospheric_correction", data=data, method=method, elevation_model=elevation_model, options=options
    )
...
def linear_scale_range(x, inputMin, inputMax, outputMin=UNSET, outputMax=UNSET) -> ProcessBuilder:
    ...
    """
    return _process(
        "linear_scale_range", x=x, inputMin=inputMin, inputMax=inputMax, outputMin=outputMin, outputMax=outputMax
    )
...
def resample_spatial(data, resolution=UNSET, projection=UNSET, method=UNSET, align=UNSET) -> ProcessBuilder:
    ...
    """
    return _process(
        "resample_spatial", data=data, resolution=resolution, projection=projection, method=method, align=align
    )
