...
#    openeo/internal/processes/generator.py ../openeo-processes/ ../openeo-processes/proposals/array_modify.json ../openeo-processes/proposals/array_concat.json ../openeo-processes/proposals/array_interpolate_linear.json --output openeo/processes.py
