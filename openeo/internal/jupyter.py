...
TABLE_COLUMNS = {
    "jobs": {
        ...
        "created": {"name": "Submitted", "format": "Timestamp", "sort": "desc"},
        "updated": {"name": "Last update", "format": "Timestamp"},
    },
    "services": {
        "id": {"name": "ID", "primaryKey": True},
        "title": {"name": "Title"},
    ...
    "files": {
        ...
        "size": {"name": "Size", "format": "FileSize", "filterable": False},
        "modified": {"name": "Last modified", "format": "Timestamp"},
    },
}
