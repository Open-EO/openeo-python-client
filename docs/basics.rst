...
pixels to 0 and all other pixels to 1 using a simple comparison::
   ...
   >>> s2_sceneclassification = session.load_collection("TERRASCOPE_S2_TOC_V2",bands=["SCENECLASSIFICATION_20M"]) \
...
aggregated NDVI value:
   ...
   >>> timeseries_dict = session.load_collection("TERRASCOPE_S2_TOC_V2",
