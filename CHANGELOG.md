...
- Initial implementation of pytest plugin `auto_list_job_ids` to automatically list job ids of jobs created during a test ([#922](https://github.com/Open-EO/openeo-python-client/issues/922))
