...
- Created superclass `CubeMetadata` for `CollectionMetadata` containing methods to handle basic metadata like dimensions and their labels, without requiring STAC information. ([#464](https://github.com/Open-EO/openeo-python-client/issues/464))
### Removed
