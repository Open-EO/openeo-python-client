...
def test_parameter_spatial_extent():
    assert Parameter.spatial_extent().to_dict() == {'description':
                                                        'Limits the data to process to the specified bounding box or '
                                                        'polygons.\n'
                                                        '\n'
                                                        ...
                                                        'extent. ',
                                                    'name': 'spatial_extent',
                                                    'schema': [{'properties': {'base': {'default': None,
                                                                                        'description': 'Base (optional, lower '
                                                                                                       'left corner, coordinate '
                                                                                                       'axis 3).',
                                                                                        'type': ['number', 'null']},
                                                                               'crs': {'anyOf': [{'examples': [3857],
                                                                                                  'minimum': 1000,
                                                                                                  'subtype': 'epsg-code',
                                                                                                  'title': 'EPSG Code',
                                                                                                  'type': 'integer'},
                                                                                       ...
                                                                                       'description': 'Coordinate reference '
                                                                                                      ...
                                                                                                      'reference system.'},
                                                                               'east': {
                                                                                   'description': 'East (upper right corner, '
                                                                                                  'coordinate axis 1).',
                                                                                   'type': 'number'},
                                                                               'height': {'default': None,
                                                                                          'description': 'Height (optional, upper '
                                                                                                         'right corner, '
                                                                                                         'coordinate axis 3).',
                                                                                          'type': ['number', 'null']},
                                                                               'north': {
                                                                                   'description': 'North (upper right '
                                                                                                  'corner, coordinate axis '
                                                                                                  '2).',
                                                                                   'type': 'number'},
                                                                               'south': {
                                                                                   'description': 'South (lower left '
                                                                                                  'corner, coordinate axis '
                                                                                                  '2).',
                                                                                   'type': 'number'},
                                                                               'west': {
                                                                                   'description': 'West (lower left corner, '
                                                                                                  'coordinate axis 1).',
                                                                                   'type': 'number'}},
                                                                ...
                                                                'type': 'object'},
                                                               {
                                                                   ...
                                                                   'type': 'object'},
                                                               {
                                                                   'description': "Don't filter spatially. All data is included in "
                                                                                  'the data cube.',
                                                                   'title': 'No filter',
                                                                   'type': 'null'}]}
