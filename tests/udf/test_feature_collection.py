        ...
        "data": {
            ...
            "features": [
                ...
                },
                {
                    "id": "2",
                    "type": "Feature",
                    "properties": {"a": 33, "b": 13},
                    "geometry": {"coordinates": (8.0, 13.0), "type": "Point"},
                    "bbox": (8.0, 13.0, 8.0, 13.0),
                },
            ],
...
@pytest.mark.parametrize(
    ["dates", "exc"], [([], "Expected size 1 but got 0"), (["2021-01-02", "2021-01-05"], "Expected size 1 but got 2")]
)
